					...
					<div class='row'>
									...
									<form class='form-horizontal'>
										...
										<div class='input-group'>
											...
											<select class='form-control select2' id='impuesto' style='width: 100%;' onchange="actualiza_impuesto_temp();">
												...
												<option value='17'>17 % de Impuesto</option>
												<option value='18'>18 % de Impuesto</option>
											</select>
										</div>
										<br>
										<div class='input-group'>
											<span class='input-group-addon bg-purple'><i class="fa fa-plus"></i> Descuento (% en porc.):</span>
											<input type="text" class="form-control cantidades" id="descuento" onchange="actualiza_descuento_temp();" data-inputmask="'alias': 'numeric', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'placeholder': '0'">
										</div>
									</form>
								</div>
							</div>
							...
							<div class='box box-primary'>
								...
								<div class='box-body'>
									<div class='input-group'>
										...
										<input type="text" class="form-control pull-right" id="codigo" onchange='busca_articulo();' style="font-size:20px; text-align:center; color:blue; font-weight: bold;" >
									</div>
									<br>
									<div class='input-group'>
									...
									<div class='input-group'>
										...
										<input type="text" class="form-control pull-right cantidades" id="costo" data-inputmask="'alias': 'numeric', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'placeholder': '0'" style="font-size:20px; text-align:center; color:blue; font-weight: bold;" disabled>
									</div>
									<br>
									<div class='input-group'>
						...
						<div class='col-md-4'>
							<div class='box box-primary'>
								<div class='box-header with-border'>
									<div class='btn-group'>
										<button class='btn btn-primary' type='button' onclick='procesa_entrada();' id='btn-procesa' disabled>
											<i class='fa fa-external-link'></i> Procesar entrada.
										</button>
								...
								<div class='box-body'>
									<div class='input-group'>
										...
										<input type="text" class="form-control pull-right" id="net" value='' style="font-size:20px; text-align:center; color:blue; font-weight: bold;" disabled>
									</div>

									<div class='input-group'>
										<span class='input-group-addon bg-purple'><i class="fa fa-dollar"></i> Descuento:</span>
										<input type="text" class="form-control pull-right" id="des" value='' style="font-size:20px; text-align:center; color:blue; font-weight: bold;" disabled>
									</div>
									
									<div class='input-group'>
										<span class='input-group-addon bg-purple'><i class="fa  fa-repeat"></i> Monto + IGV:</span>
										<input type="text" class="form-control pull-right" id="tot" value='' style="font-size:20px; text-align:center; color:blue; font-weight: bold;" disabled>
									</div>

									<div class='input-group'>
										<span class='input-group-addon bg-purple'><i class="fa fa-list-ol"></i> Articulos:</span>
										<input type="text" class="form-control pull-right" id="arts" value='' style="font-size:20px; text-align:center; color:blue; font-weight: bold;" disabled>
									</div>
								</div>
							</div>
						</div>
