...
<html>
  ...
  <body onload="pone_lista_clientes();">
          ...
          <div class='row'>
           <div class='col-md-12'>
             <div class='nav-tabs-custom'>
                  ...
                  <li class="pull-left header"><i class="fa fa-file-text"></i> Operaciones con Clientes.</li>
                </ul>
               <div class="tab-content">
                  <div class="tab-pane active" id="altas">
                    ...
                    <br>
                    <div class="btn-group">
                    <button type='button' class='btn btn-primary btn-lg' onclick='procesa_clientes();' id='btn-altas'><i class='fa fa-check-circle'></i> Registrar Cliente.</button>
                    </div>
                    </form>
                  </div><!-- /.tab-pane -->
                  ...
                  <div class="tab-pane" id="bajas">
                    ...
                    <div class='form-group'>
                    <label for="linea" class="col-sm-2 control-label">Clientes:</label>
                    <div class="col-sm-2">
                    <input type="text" class="form-control cantidades" id='clientes' placeholder='# Linea' onblur="busca_clientes();"
                    data-inputmask="'alias': 'numeric', 'autoGroup': true, 'digits': 0, 'digitsOptional': false">
                    <br>
                    <div id='clientes_descripcion'></div>
                    </div>
                    </div>
    ...
    <script src="plugins/datatables/jquery.dataTables.min.js"></script>
    <script src="plugins/datatables/dataTables.bootstrap.min.js"></script>
    <script src="dist/js/source_clients2.js"></script>
    <script>
