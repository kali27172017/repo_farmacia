						...
						<div class='col-md-12'>
							<div class='nav-tabs-custom'>
								<ul class="nav nav-tabs pull-right">
									<li><a href="#cambios" data-toggle="tab">Actualizar</a></li>
									<li><a href="#bajas" data-toggle="tab">Eliminar</a></li>
									<li class="active"><a href="#altas" data-toggle="tab">Registrar</a></li>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="altas">
										<form class="form-horizontal">
											...
											<div class='form-group'>
												<label for="codigostock" class="col-sm-2 control-label">Stock Minimo:</label>
												<div class="col-sm-3">
													<input type="text" class="form-control" id='codigostock' placeholder='Stock Minimo'>
												</div>
											</div>
											...
											<div class='form-group'>
												...
												<div class="col-sm-2">
													<input type="text" class="form-control cantidades" id='costo' placeholder='Costo del articulo' data-inputmask="'alias': 'numeric', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'placeholder': '0'">
												</div>
											</div>
											...
											<div class='form-group'>
												...
												<div class="col-sm-2">
													<input type="text" class="form-control cantidades" id='precio' placeholder='Precio al publico del articulo' data-inputmask="'alias': 'numeric', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'placeholder': '0'">
												</div>
											</div>
