<?php
	...
	articulo,costo,cantidad,tipo,descripcion_articulo,descripcion_prov) values('$fecha','$proveedor','$factura','$impuesto','$descuento','$articulo','$costo','$cantidad','$tipo','$desc_articulo','$desc_prov')";
