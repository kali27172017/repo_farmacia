...
if($tipo=='por_linea'){
  ...
  if($caja=='0'){
    ...
    k.codigo=a.codigo and a.linea='$linea' and a.grupo='1' order by k.id";
  }
  if($caja=='1'){
    $cadena="Select k.tipo,k.codigo,a.descripcion,a.costo,k.preciou,k.cantidad from kardex k, articulos a
    where (k.tipo='STCR' or k.tipo='STCO' or k.tipo='CT') and k.fecha>='$fi' and k.fecha<='$ff' and
    k.codigo=a.codigo and k.serie=1 and a.linea='$linea' and a.grupo='1' order by k.id";
  }
  if($caja=='2'){
    $cadena="Select k.tipo,k.codigo,a.descripcion,a.costo,k.preciou,k.cantidad from kardex k, articulos a
    where (k.tipo='STCR' or k.tipo='STCO' or k.tipo='CT') and k.fecha>='$fi' and k.fecha<='$ff' and
    k.codigo=a.codigo and k.serie=2 and a.linea='$linea' and a.grupo='1' order by k.id";
  }
  if($caja=='3'){
    $cadena="Select k.tipo,k.codigo,a.descripcion,a.costo,k.preciou,k.cantidad from kardex k, articulos a
    where (k.tipo='STCR' or k.tipo='STCO' or k.tipo='CT') and k.fecha>='$fi' and k.fecha<='$ff' and
    k.codigo=a.codigo and k.serie=3 and a.linea='$linea' and a.grupo='1' order by k.id";
  }
  if($caja=='4'){
    $cadena="Select k.tipo,k.codigo,a.descripcion,a.costo,k.preciou,k.cantidad from kardex k, articulos a
    where (k.tipo='STCR' or k.tipo='STCO' or k.tipo='CT') and k.fecha>='$fi' and k.fecha<='$ff' and
    k.codigo=a.codigo and k.serie=4 and a.linea='$linea' and a.grupo='1' order by k.id";
  }
...
if($tipo=='general'){
  $array=array();
   $trae_lineas=$db->consulta("Select linea,descripcion from lineas where linea<>0 and grupo=1 order by linea");
