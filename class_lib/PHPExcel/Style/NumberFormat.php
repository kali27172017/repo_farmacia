...
class PHPExcel_Style_NumberFormat extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
	...
	const FORMAT_CURRENCY_USD				= 'S/.#,##0_-';
	...
	private static function fillBuiltInFormatCodes()
	{
		...
		if (is_null(self::$_builtInFormats)) {
			...
			self::$_builtInFormats[44] = '_("S/."* #,##0.00_);_("S/."* \(#,##0.00\);_("S/."* "-"??_);_(@_)';
			...
			// CHT
			self::$_builtInFormats[27] = '[S/.-404]e/m/d';
			self::$_builtInFormats[30] = 'm/d/yy';
			self::$_builtInFormats[36] = '[S/.-404]e/m/d';
			self::$_builtInFormats[50] = '[S/.-404]e/m/d';
			self::$_builtInFormats[57] = '[S/.-404]e/m/d';
