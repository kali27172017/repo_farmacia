          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="valida_cambio.php?opt=72528422"><i class="fa fa-sort-numeric-asc"></i> Ajustes de Inventario.</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="valida_cambio.php?opt=725284221"><i class="fa fa-folder-open"></i> Respaldo de BD.</a></li>
